...
## ***************************************************************************
## CHECK WHETHER THE UCI HAR DATASET IS AVAILABLE AND EXIT THE SCRIPT IF NOT
## ***************************************************************************
if(!file.exists("./UCI HAR Dataset")) {
    stop("Please ensure that you have the UCI HAR Dataset unzipped in your
         working directory.")
    } else {
...
## ***************************************************************************
    ...
    ## remove the parentheses from the column names to make them legal for R 
    ## by substituting a blank ("") for all instances of "(", ")", and "-" 
    ## (using escape characters for the parentheses; "\\(|\\)|-" is a regular
    ## expression meaning "open parentheses OR close parentheses OR dash."
...
## ***************************************************************************
    ...
    ## data frame to create a long-form data set
